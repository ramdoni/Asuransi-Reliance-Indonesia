...
class CreateTableSyariahUnderwriting extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('syariah_underwritings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('syariah_underwriting');
    }
}
