                    ...
                    <div class="row">
                        <div class="pr-5 col-md-6">
                            ...
                            <div class="px-0 form-group col-md-12">
                                ...
                                <input type="text" class="form-control" wire:model="recipient" disabled />
                                @error('recipient')
                                <ul class="parsley-errors-list filled" id="parsley-id-29"><li class="parsley-required">{{ $message }}</li></ul>
                                @enderror
                            </div>
                            <div class="px-0 form-group col-md-12">
                                ...
                                <select class="form-control" wire:model="reference_type" disabled>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>{{ __('Payment Date') }} *<small>*<small>{{__('Default today')}}</small></small></label>
