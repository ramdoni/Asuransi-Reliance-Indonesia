                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" {{$is_readonly?'disabled':''}} class="form-control" wire:model="payment_date" />
                                @error('payment_date')
                                <ul class="parsley-errors-list filled" id="parsley-id-29"><li class="parsley-required">{{ $message }}</li></ul>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <select class="form-control" {{$is_readonly?'disabled':''}} wire:model="bank_account_id">
